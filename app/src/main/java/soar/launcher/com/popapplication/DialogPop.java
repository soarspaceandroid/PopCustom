...
public class DialogPop extends PopupWindow {
	...
	private LinearLayout vLineLyButtonGroup;
	private LinearLayout vLineLyMessageContainer;
	...
	public DialogPop(Context context , int width, int height) {
		super(width, height);
	...
	public DialogPop(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		initBaseView();
	}
	...
	public static class Builder{
		...
		private DialogPop generalAccessDialog;
		...
		private void init(){
			generalAccessDialog = new DialogPop(context , ViewGroup.LayoutParams.MATCH_PARENT,
